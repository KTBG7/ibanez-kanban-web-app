...
import { handleBoardSubmit } from '../../utils/eventHandlers';
...
const BoardList = () => {
  ...
  const handleSubmit = (emptyCols: boolean, idx: number) => {
    if (!emptyCols) {
      handleBoardSubmit(context, idx, boardTitle, columns, closeModal, false);
    } else {
